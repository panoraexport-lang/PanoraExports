                        ...
                        >
                            ...
                            <div className="relative aspect-[16/10] bg-slate-100 dark:bg-slate-900 overflow-hidden">
                                <img
                                    ...
                                    alt={category.name}
                                    loading="lazy"
                                    className="absolute inset-0 w-full h-full object-cover transition-all duration-700 blur-[4px] grayscale group-hover:blur-0 group-hover:grayscale-0 group-hover:scale-105"
                                />
